...
input_mne{5}    = '204521_MEG_3-Restin_icamne.mat';
% input_mne{6}    = '149741_MEG_3-Restin_icamne.mat';
input_mne{6}    = '599671_MEG_3-Restin_icamne.mat';
input_mne{7}    = '162026_MEG_3-Restin_icamne.mat';
% input_mne{8}    = '187547_MEG_3-Restin_icamne.mat';
input_mne{8}    = '725751_MEG_3-Restin_icamne.mat';


% compress_indx(input_mne, 'compress_result_8_resting', 14, 1.7, 1)
compress_indx(input_mne, 'compress_result_8_resting', 24, 3, 1, 1, 'parcellations_VGD11b_4k')