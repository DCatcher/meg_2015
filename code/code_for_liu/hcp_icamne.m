...
resultprefix    = [int2str(subjectid), '_MEG_3-Restin'];
...
% subjectid   = '102816';
hcp_read_matlab([int2str(subjectid) '_MEG_anatomy_sourcemodel_2d']);
...
hcp_read_matlab(sprintf('%s.mat', [int2str(subjectid) '_MEG_anatomy_headmodel']));
